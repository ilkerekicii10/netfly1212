...
// They will follow a similar pattern: get data from req.body, run db query, send response.
// Example for adding orders
...
// Generic CRUD for simple tables (colors, producers, defect_reasons)
